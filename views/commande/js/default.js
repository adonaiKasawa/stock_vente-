...
$(document).ready(function () {
    ...
    let dataTable_commandes = $('#table_commandes').DataTable({
        ...
        "order": [],
        "ajax": {
            url: path + "commande/xhr_commandes_DataTable",
            type: "POST"
        }
    });
    ...
    $(document).on('click', '#btn_valider_ajouter_commande', function (e) {
        ...
        $.ajax({
            url: path + "commande/ajouter_une_commande",
            type: 'POST',
            dataType: 'JSON',
    ...
    $(document).on('click', '.btn_valider_commande', function (e) {
        ...
        $.ajax({
            url: path + "commande/valider_commande",
            type: 'POST',
            dataType: 'JSON',
            data: {commande_id},
            success: function (data) {
    ...
    $(document).on('click', '.btn_annuler_commande', function (e) {
        ...
        let commande_id = $(this).attr('id');
        $.ajax({
            url: path + "commande/annuler_commande",
            type: 'POST',
            dataType: 'JSON',
            data: {commande_id},
            success: function (data) {
    ...
    $(document).on('click', '.btn_voir_commande', function (e) {
        ...
        let commande_id = $(this).attr('id');
        $.ajax({
            url: path + "commande/voir_commande",
            type: 'POST',
            dataType: 'JSON',
            data: {commande_id},
            success: function (data) {
    ...
    function reloadDataTableGetCommande(getType, date = null, date_debut = null, date_fin = null, fournisseur = 0, etat = 0) {
        if (getType == 1) {
            if (date == '') {
                ...
                dataTable_commandes.ajax.url(path + "commande/xhrDatatableGetCommandeDate/" + date + "/?fournisseur=" + fournisseur + "&etat=" + etat).load();
            }
        } else if (getType == 2) {
            if (date_debut == '' || date_fin == '') {
                ...
                dataTable_commandes.ajax.url(path + "commande/xhrDatatableGetCommandePeriode/" + date_debut + "/" + date_fin + "/?fournisseur=" + fournisseur + "&etat=" + etat).load();
            }
        }
    }
